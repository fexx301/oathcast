...
minimum local margin of `0.206250`. Its synthetic ordinal Spearman is `0.958919`
...
The current frozen rank-only artifact is a 45,395-byte local candidate. Its
...
| WASM byte size | `45,395` bytes |
| WASM SHA-256 | `8d9c6d362acbd5cf3f0d3fb358f7f763e747cf96a0e6d5bf2e2b40fc6b4bce6c` |
| Raw-byte Keccak-256 (portal-compatible) | `0xef42c86fe9d1d1485693c8ba9d724b48cd2883d34d4cb6212c31ef8a2c5494ce` |
...
registration `41`'s 42,798-byte artifact and the current 45,395-byte local
candidate.
...
current 45,395-byte candidate, Stage 1 passed by reaching
