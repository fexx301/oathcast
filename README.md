...
build commands and safeguards. The current frozen rank-only artifact is 45,681
bytes with SHA-256
`d108532c673a3f94010b140333037af93e677ae54148d7f67c42fb2fd3ccef95` and
raw-byte Keccak-256
`0x537bf9a7da427e292994ecce7f317e187996345a3a4503901b764ddadd9fbc5f`.
...
emit 45,681 bytes with different content under the same pinned `rustc 1.95.0` and
...
records the 45,681-byte local candidate artifact, the registered 42,798-byte
...
`0.206250`. Its synthetic ordinal Spearman is `0.956604`; that metric measures
