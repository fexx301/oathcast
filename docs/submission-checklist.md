...
- [x] Canonical draft YAML with declared `0.01 USDC` minimum price.
...
- [ ] Frozen Hackathon 1 YAML validated by the official validator.
- [ ] Canonical Miner registered and discoverable.
- [ ] Three active Miners in the same Intent, if pursuing the global cash-prize guardrail.
...
- [ ] Official Canonical Script and WASM boilerplate received.
- [ ] Script compiled and tested in the official sandbox.
...
- [ ] Limitations and non-binding planning scope are visible.
